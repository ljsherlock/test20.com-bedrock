...
abstract class Widget extends \WP_Widget {
  ...
  public function newInstance($instance, $id, $title) {
    $newInstance = new \stdClass();
    $newInstance->id = $this->get_field_id($id);
    $newInstance->value = isset ($instance[$id]) ? esc_attr ($instance[$id]) : '';
    $newInstance->name = $this->get_field_name($id);
