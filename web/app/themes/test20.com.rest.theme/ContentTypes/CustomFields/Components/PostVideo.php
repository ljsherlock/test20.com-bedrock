...
class PostVideo extends \ContentTypes\CustomFields {
  /**
   * registerFields
   *
  ...
  public static function registerFields($objectTypes = array(), $showOn = array()) {
    $mainVideoMetabox = new_cmb2_box( array(
      'id'           => self::$prefix . 'mainVideoMetabox',
      'title'        => esc_html__( 'Main Video', 'cmb2' ),
    ...
    $mainVideoMetabox->add_field( array(
      'name' => 'Adding Video',
    ...
    $postVideoDirectGroup = $mainVideoMetabox->add_field( array(
      'id'      => 'postVideoDirect',
      'type'        => 'group',
    ...
    $mainVideoMetabox->add_group_field( $postVideoDirectGroup, array(
      'name'    => 'Video URL',
    ...
    $postVideoIframeGroup = $mainVideoMetabox->add_field( array(
      'id'      => 'postVideoIframe',
      'type'        => 'group',
    ...
    $mainVideoMetabox->add_group_field( $postVideoIframeGroup, array(
      'name'    => 'Iframe URL',
      'id'      => 'url',
      'type'    => 'text_url',
